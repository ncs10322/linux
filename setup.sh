...
printf "======================================\n"
printf "\n"
printf "①  SELinux 모드를 permissive 으로 변경하였습니다.\n"
setenforce 0
sed -i 's/SELINUX=enforcing/SELINUX=permissive/g' /etc/selinux/config
printf "\n"
sleep 3
printf "②  firewalld 방화벽 기능을 해지하였습니다.\n"
systemctl disable --now firewalld
printf "\n"
sleep 3
printf "③  'httpd', 'gnome-tweaks', 'gnome-extensions-app' 패키지를 설치하고 윈도우 환경을 설정하였습니다.\n"
...
printf "\n"
sleep 3
printf "④  절전 모드 및 화면 잠금 기능을 해지하였습니다.\n"
...
printf "\n"
sleep 3
printf "⑦  바탕화면에 터미널 아이콘을 생성하였습니다.\n"
ln -s /usr/bin/gnome-terminal /root/바탕화면/터미널
printf "\n"
sleep 3
printf "⑧  user1, user2 계정을 생성하였습니다.\n"
useradd user1
useradd user2
